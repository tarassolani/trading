...
<body>
    <nav>
        <div id="menu-icon" class="material-symbols-outlined" onclick="window.open('../search/search.php', '_self')">
            &#xe8b6;</div>
    ...
    <table class="dashboard-table">
                ...
                <div class="account-info">
                    <div id="left-div">
                        ...
                        <div class="wallet-info">
                            ...
                            <span class="material-symbols-outlined copy-btn" id="btn-inviz"
                                onclick="copyContent()">content_copy</span>
        ...
        <tr>
            <td class="dashboard-cell" id="positions-cell" colspan="2">
                <div class="positions">
                    <h3>Positions</h3>
        ...
        <tr>
            <td class="dashboard-cell" id="friends-cell" colspan="2">
                <div class="friends">
                    <div id="friend-titles">
                        <h3 id="left-title">Friends</h3>
                        <h3 id="right-title">Add Friends</h3>
                    </div>
